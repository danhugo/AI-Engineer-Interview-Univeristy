"""
AI / Machine Learning — Weight Decay vs L2 Regularization
PRACTICE FILE
...
def sgd_with_weight_decay(w, grad, lr, weight_decay):
    ...
    HINT:
      w_new = (1 - lr * weight_decay) * w - lr * grad
    """
    pass
...
def adam_like_coupled_l2_step(w, grad, lr, l2_lambda, preconditioner):
    ...
    HINT:
      preconditioner is a per-parameter multiplier applied to the whole gradient.
    """
    pass
...
def adam_like_decoupled_decay_step(w, grad, lr, weight_decay, preconditioner):
    ...
    HINT:
      Shrink w directly, then subtract lr * preconditioner * grad.
    """
    pass
